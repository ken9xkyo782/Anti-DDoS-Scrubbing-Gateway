        ...
        <div className={styles.group}>
          ...
          {role === 'tenant_user' && (
            <>
              ...
              <NavLink to="/ddos" className={getActiveClassName}>
                <span className={styles.navIcon}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                </span>
                <span className={styles.navText}>DDoS Protection</span>
              </NavLink>
            </>
          )}
          ...
          {role === 'admin' && (
            <>
              ...
              <NavLink to="/admin/ddos" className={getActiveClassName}>
                <span className={styles.navIcon}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                </span>
                <span className={styles.navText}>DDoS Protection</span>
              </NavLink>
              <NavLink to="/admin/amplification" className={getActiveClassName}>
                <span className={styles.navIcon}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L4.5 13H11l-1 9 8.5-11H12l1-9z"/></svg>
                </span>
                <span className={styles.navText}>UDP Reflection &amp; Amplification</span>
              </NavLink>
